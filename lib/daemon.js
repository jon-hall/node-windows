    ...
    _xml: {
      ...
      get: function(){
        return require('./winsw').generateXml({
          ...
          // If the account and password have been set on 'user' then pass them through to the xml config
          user: this.user.account != null && this.user.password != null ? this.user : null
        });
      }
    },
